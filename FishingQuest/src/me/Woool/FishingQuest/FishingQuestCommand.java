...
public class FishingQuestCommand implements CommandExecutor {
	...
	public void promptFishermanDialogue(Player p, int delay, String msg) {
		...
		}.runTaskLater(this.plugin, (40L *delay));
			...
			switch (Utils.playerPhase.get(plr)) {
				...
				case 1:
					...
					if (plr.getItemInHand().getItemMeta() != null && plr.getItemInHand().getItemMeta().equals(Utils.getTropicalFish().getItemMeta())) {
						...
						plr.sendMessage(ChatColor.GRAY + "You can obtain it from fishing with your rod.");
						return true;
				...
				case 2:
					...
					if (plr.getItemInHand().getItemMeta() != null && plr.getItemInHand().getItemMeta().equals(Utils.getDriedFish().getItemMeta())) {
						...
						plr.sendMessage(ChatColor.GRAY + "(Try using your " + ChatColor.AQUA + "Time O'Rod " + ChatColor.GRAY + "to teleport to where the dried fish might be?" );
						return true;
					...
					new BukkitRunnable() {
						...
						public void run() {
							...
							plr.sendMessage(ChatColor.RED + "- Combat Rod (just kidding, this isn't done)");
							plr.sendMessage(ChatColor.AQUA + "- +5,000XP");
							plr.sendMessage(ChatColor.GOLD + "- +5,000g (no.)");
